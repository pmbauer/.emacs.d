...
(defun esk-pretty-fn nil (font-lock-add-keywords nil `(("(\\(fn\\>\\)" (0 (progn (compose-region (match-beginning 1) (match-end 1) (make-char 'greek-iso8859-7 107)) nil))))))

(add-hook 'clojure-mode-hook 'esk-pretty-fn)

;;;***

;;;### (autoloads nil nil ("starter-kit-lisp-pkg.el") (20187 60496
;;;;;;  554577))
